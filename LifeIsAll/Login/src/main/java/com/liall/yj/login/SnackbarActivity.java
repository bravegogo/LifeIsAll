...
private Button button_webview;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button_webview = findViewById(R.id.webview_btn);
//
//        findViewById(R.id.webview_btn).setOnClickListener((View.OnClickListener) this);
...
//        button_webview =  findViewById(R.id.webview_btn);
        ...
        button_webview.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SnackbarActivity.this,MainActivity2.class);
...
//     public void onClick() {
//        onClick();
//        Log.i("xxxxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxxxxx");
//     }
